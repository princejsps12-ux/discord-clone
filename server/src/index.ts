...
app.post("/api/servers", auth, async (req: AuthRequest, res) => {
  const { name, imageUrl } = req.body as { name: string; imageUrl?: string };
...
app.get("/api/servers", auth, async (req: AuthRequest, res) => {
...
app.post("/api/servers/join/:inviteCode", auth, async (req: AuthRequest, res) => {
...
app.get("/api/servers/:serverId/channels", auth, async (req: AuthRequest, res) => {
...
app.get("/api/servers/:serverId/members", auth, async (req: AuthRequest, res) => {
...
app.post("/api/channels/:channelId/read", auth, async (req: AuthRequest, res) => {
...
app.patch("/api/channels/:channelId/preferences", auth, async (req: AuthRequest, res) => {
...
app.get("/api/search", auth, async (req: AuthRequest, res) => {
...
app.get("/api/servers/:serverId/scheduled-calls", auth, async (req: AuthRequest, res) => {
  const ok = await prisma.member.findUnique({
    where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
  });
  if (!ok) return res.status(403).json({ error: "Forbidden" });
...
app.post("/api/servers/:serverId/scheduled-calls", auth, async (req: AuthRequest, res) => {
  const ok = await prisma.member.findUnique({
    where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
  });
  if (!ok) return res.status(403).json({ error: "Forbidden" });
...
app.get("/api/scheduled-calls/:id", auth, async (req: AuthRequest, res) => {
...
app.delete("/api/scheduled-calls/:id", auth, async (req: AuthRequest, res) => {
...
app.post("/api/servers/:serverId/channels", auth, async (req: AuthRequest, res) => {
  const member = await prisma.member.findUnique({
    where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
  });
...
app.get("/api/channels/:channelId/messages", auth, async (req: AuthRequest, res) => {
...
app.post("/api/channels/:channelId/messages", auth, async (req: AuthRequest, res) => {
...
app.patch("/api/messages/:messageId", auth, async (req: AuthRequest, res) => {
...
app.delete("/api/messages/:messageId", auth, async (req: AuthRequest, res) => {
  const existing = await prisma.message.findUnique({
    where: { id: param(req, "messageId") },
    include: { member: true },
  });
...
app.post("/api/messages/:messageId/reactions", auth, async (req: AuthRequest, res) => {
