...
export function inferMessageCategory(text: string): MessageCategory {
  ...
  if (
    /placement|interview|amazon|google|microsoft|meta|flipkart|razorpay|salary|offer|lpa|resume|hr round|oa\b|online assessment|leetcode premium|company/.test(
      t,
    )
  ) {
    return "PLACEMENT";
