...
export function registerStudentFeatures(
  ...
  app.post("/api/ai/ask", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.patch("/api/messages/:messageId/meta", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.get("/api/bookmarks", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.post("/api/messages/:messageId/bookmark", auth, async (req: AuthRequest, res: Response) => {
    const existing = await prisma.message.findUnique({ where: { id: param(req, "messageId") } });
    if (!existing) return res.status(404).json({ error: "Not found" });
    const member = await prisma.member.findUnique({
      where: { userId_serverId: { userId: req.userId!, serverId: existing.serverId } },
  ...
  app.delete("/api/messages/:messageId/bookmark", auth, async (req: AuthRequest, res: Response) => {
    await prisma.bookmark.deleteMany({ where: { userId: req.userId!, messageId: param(req, "messageId") } });
    res.json({ ok: true });
  });

  app.get("/api/servers/:serverId/notes", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.post("/api/servers/:serverId/notes", auth, async (req: AuthRequest, res: Response) => {
    const ok = await prisma.member.findUnique({
      where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
    });
    if (!ok) return res.status(403).json({ error: "Forbidden" });
  ...
  app.post("/api/channels/:channelId/polls", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.get("/api/channels/:channelId/polls", auth, async (req: AuthRequest, res: Response) => {
    const channel = await prisma.channel.findUnique({ where: { id: param(req, "channelId") } });
  ...
  app.post("/api/polls/:pollId/vote", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.post("/api/channels/:channelId/study-sessions", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.post("/api/study-sessions/:sessionId/join", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.patch("/api/study-sessions/:sessionId/end", auth, async (req: AuthRequest, res: Response) => {
    const session = await prisma.studySession.findUnique({ where: { id: param(req, "sessionId") } });
  ...
  app.get("/api/channels/:channelId/study-sessions/active", auth, async (req: AuthRequest, res: Response) => {
    const channel = await prisma.channel.findUnique({ where: { id: param(req, "channelId") } });
    if (!channel) return res.status(404).json({ error: "Not found" });
    const member = await prisma.member.findUnique({
      where: { userId_serverId: { userId: req.userId!, serverId: channel.serverId } },
  ...
  app.get("/api/streak/me", auth, async (req: AuthRequest, res: Response) => {
  ...
  app.get("/api/servers/:serverId/leaderboard", auth, async (req: AuthRequest, res: Response) => {
    const ok = await prisma.member.findUnique({
      where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
    });
    if (!ok) return res.status(403).json({ error: "Forbidden" });
  ...
  app.get("/api/servers/:serverId/analytics", auth, async (req: AuthRequest, res: Response) => {
    const ok = await prisma.member.findUnique({
      where: { userId_serverId: { userId: req.userId!, serverId: param(req, "serverId") } },
    });
    if (!ok) return res.status(403).json({ error: "Forbidden" });
